...
0
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/default/common/header_common.htm', 1437287743, '5', './data/template/6_5_common_header_forum_forumdisplay.tpl.php', './template/yunshan_vivo', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_qmenu.htm', 1437287743, '5', './data/template/6_5_common_header_forum_forumdisplay.tpl.php', './template/yunshan_vivo', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/pubsearchform.htm', 1437287743, '5', './data/template/6_5_common_header_forum_forumdisplay.tpl.php', './template/yunshan_vivo', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_userstatus.htm', 1437287743, '5', './data/template/6_5_common_header_forum_forumdisplay.tpl.php', './template/yunshan_vivo', 'common/header_forum_forumdisplay')
;?>
...
<?php } ?>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/sea.js?<?php echo VERHASH;?>" type="text/javascript"></script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/seajs.config.js?<?php echo VERHASH;?>" type="text/javascript" type="text/javascript"></script>
</head>
...
<?php } ?><div id="qmenu_menu" class="p_pop <?php if(!$_G['uid']) { ?>blk<?php } ?>" style="display: none;"><?php if($_G['uid']) { ?>
<div id="um" class="cl">
<div class="avt"><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="访问我的空间"><?php echo avatar($_G[uid],middle);?></a></div>
<p>
<a id="username" href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="访问我的空间" class="vip"><?php echo $_G['member']['username'];?></a>
</p>
<p>
<a href="home.php?mod=spacecp&amp;ac=credit&amp;showcredit=1" id="extcreditmenu"><span>积分: </span><?php echo $_G['member']['credits'];?></a>
<span class="pipe">|</span><a href="home.php?mod=spacecp&amp;ac=usergroup" id="g_upmine"><span>用户组:</span> <?php echo $_G['group']['grouptitle'];?><?php if($_G['member']['freeze']) { ?><span class="xi1">(已冻结)</span><?php } ?></a>
</p>
</div>
<?php } ?>
...
<?php } ?><?php echo adshow("headerbanner/wp a_h");?><div id="nv">
        <div id="hd">
<div class="wp">
<div class="hdc cl"><?php $mnid = $mnid ? $mnid : getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2>
<div id="nav">
...
<div class="y"><?php if($_G['setting']['search']) { $slist = array();?><?php if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?php
$slist[forumfid] = <<<EOF
...
<div id="unav">
<?php if($_G['uid']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="访问我的空间" id="qmenu" class="showmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'33!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})" onClick="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'33!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);});return false;"><?php echo $_G['member']['username'];?></a>
<span class="pipe">|</span><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">退出</a>
<?php } else { ?>
<a href="member.php?mod=logging&amp;action=login" class="xi2 xw1">登录</a>
