...
<div class="deanfttop">
        	<div class="w1180">
                ...
                <div class="deanfttr">
                	<div class="deanfttrt">
                    	<span><img src="<?php echo $_G['style']['styleimgdir'];?>/web2_bottom_kefu_phone.png" /></span>
                        <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=1691779149&amp;site=qq&amp;menu=yes" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/web2_bottom_kefu_qq.png" /></a>
                    </div>
                    <div class="deanfttrb">400 123 5678</div>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div class="deanftbottom">
        	<div class="w1180">
            	<div class="deanftbl"><img src="<?php echo $_G['style']['styleimgdir'];?>/ftlogo.png" /></div>
                <div class="deanftbm">
                	<p>
                    ...
                    <p>Templated By 迪恩网络&nbsp;&nbsp;京IP备案号：BGJ15464X&nbsp;&nbsp; 穗公网监备案证第44010650000002号&nbsp;&nbsp;中国电子认证联盟实名认证</p>
                    
                </div>
                <div class="deanftbr">
                	<p>Powered by <a href="http://www.discuz.net" target="_blank">Discuz!</a> <em><?php echo $_G['setting']['version'];?></em></p>
                    <p><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a>
                    <?php } ?>&copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a></p>
                </div>
                <div class="clear"></div>
            </div>
