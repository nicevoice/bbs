...
<!--{if empty($topic) || ($topic[usefooter])}-->
	...
	<div id="ft">
	<div class="wp cl">
		<h2><a href="{if $_G['setting']['domain']['app']['default']}http://{$_G['setting']['domain']['app']['default']}/{else}./{/if}" title="$_G['setting']['bbname']"><img src="$_G['style']['styleimgdir']/vlogo.png" alt="$_G['setting']['bbname']" border="0"></a></h2>
		<div id="flk">
			<p>
				...
				<!--{loop $_G['setting']['footernavs'] $nav}--><!--{if $nav['available'] && ($nav['type'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1)) || !$nav['type'] && ($nav['id'] == 'stat' && $_G['group']['allowstatdata'] || $nav['id'] == 'report' && $_G['uid'] || $nav['id'] == 'archiver' || $nav['id'] == 'mobile' || $nav['id'] == 'darkroom'))}-->$nav[code]<span class="pipe">|</span><!--{/if}--><!--{/loop}-->
				<strong><a href="$_G['setting']['siteurl']" target="_blank">$_G['setting']['sitename']</a></strong>
				<!--{hook/global_footerlink}-->
			</p>
			<p>
			Powered by <strong><a href="http://www.discuz.net" target="_blank">Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->&copy; 2001-2013 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a>
                <!--{if $_G['setting']['icp']}--><a href="http://www.miitbeian.gov.cn/" target="_blank">$_G['setting']['icp']</a><!--{/if}-->
                <a href="http://addon.discuz.com/?@51353.developer" target="_blank">Design By 云山之巅 </a>
			</p>
			<p class="xs0">
				{lang time_now}
				<span id="debuginfo">
		...
		<div id="vivo-sns-list">
			
			<a href="#" class="sina"><b></b></a>
			<a href="#" class="tencent"><b></b></a>
			<a href="#" class="qzone" style="display:none"><b></b></a>
			<a href="#" class="renren"><b></b></a>
			<a href="#" class="weixin"><b></b></a>
