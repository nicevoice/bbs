...
0
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/default/common/header_common.htm', 1437287684, '5', './data/template/6_5_common_header_home_spacecp.tpl.php', './template/yunshan_vivo', 'common/header_home_spacecp')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_qmenu.htm', 1437287684, '5', './data/template/6_5_common_header_home_spacecp.tpl.php', './template/yunshan_vivo', 'common/header_home_spacecp')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/pubsearchform.htm', 1437287684, '5', './data/template/6_5_common_header_home_spacecp.tpl.php', './template/yunshan_vivo', 'common/header_home_spacecp')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_userstatus.htm', 1437287684, '5', './data/template/6_5_common_header_home_spacecp.tpl.php', './template/yunshan_vivo', 'common/header_home_spacecp')
;?>
