...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><img src="<?php echo $_G['setting']['attachurl'];?>common/<?php echo $_G['forum']['icon'];?>" alt="<?php echo $_G['forum']['name'];?>" /></a>
<?php } else { ?>
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><img src="<?php echo $_G['style']['styleimgdir'];?>/forum<?php if($_G['forum']['todayposts']) { ?>_new<?php } ?>.png" alt="<?php echo $_G['forum']['name'];?>" /></a>
<?php } ?>
</div>
<h1 class="xs2">
...
<div>
<?php if(!$subforumonly) { ?><span class="xs1 xw0">今日: <strong class="xi1"><?php echo $_G['forum']['todayposts'];?></strong><?php if($_G['forum']['todayposts']) { if($_G['forum']['todayposts'] < $_G['forum']['yesterdayposts']) { ?><b class="ico_fall">&nbsp;</b><?php } else { ?><b class="ico_increase">&nbsp;</b><?php } } ?><span class="pipe">|</span>主题: <strong class="xi1"><?php echo $_G['forum']['threads'];?></strong><?php if($_G['forum']['rank']) { ?><span class="pipe">|</span>排名: <strong class="xi1" title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></strong><?php if($_G['forum']['rank'] <= $_G['forum']['oldrank']) { ?><b class="ico_increase">&nbsp;</b><?php } else { ?><b class="ico_fall">&nbsp;</b><?php } } ?></span><?php } if(!empty($_G['forum']['domain']) && !empty($_G['setting']['domain']['root']['forum'])) { ?>
...
<div>
<span class="y">
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum&amp;formhash=<?php echo FORMHASH;?>" id="a_favorite" class="fa_fav" onclick="showWindow(this.id, this.href, 'get', 0);"><strong class="xi1" id="number_favorite" <?php if(!$_G['forum']['favtimes']) { ?> style="display:none;"<?php } ?>>(<span id="number_favorite_num"><?php echo $_G['forum']['favtimes'];?></span>)</strong></a>
...
<span class="pipe">|</span><a id="forumarchive" href="javascript:;" class="fa_achv" onmouseover="showMenu(this.id)">&nbsp;</a>
<?php } ?>
...
<span class="pipe">|</span><a href="<?php if($_G['adminid'] == 1) { ?>admin.php?mod=forum&action=recyclebin&frames=yes<?php } elseif($_G['forum']['ismoderator']) { ?>forum.php?mod=modcp&action=recyclebin&fid=<?php echo $_G['fid'];?><?php } ?>" class="fa_bin" target="_blank">&nbsp;</a>
...
<?php if($moderatedby) { ?><div class="moderatedby">版主: <span class="xi2"><?php echo $moderatedby;?></span></div><?php } ?>
</div>
</div>
...
<?php } if(empty($_G['forum']['sortmode'])) { if($quicksearchlist && !$_GET['archiveid']) { ?><script type="text/javascript">
...
<a id="filter_dateline" href="javascript:;" class="showmenu xi2<?php if($_GET['dateline']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)"><?php if($_GET['dateline'] == '86400') { ?>一天<?php } elseif($_GET['dateline'] == '172800') { ?>两天<?php } elseif($_GET['dateline'] == '604800') { ?>一周<?php } elseif($_GET['dateline'] == '2592000') { ?>一个月<?php } elseif($_GET['dateline'] == '7948800') { ?>三个月<?php } else { ?>全部时间<?php } ?></a>&nbsp;
<a id="filter_orderby" href="javascript:;" class="showmenu xi2<?php if($_GET['orderby']) { ?> xw1<?php } ?>" onclick="showMenu(this.id)"><?php if($_GET['orderby'] == 'dateline') { ?>发帖时间<?php } elseif($_GET['orderby'] == 'replies') { ?>回复<?php } elseif($_GET['orderby'] == 'views') { ?>查看<?php } else { ?>默认排序<?php } ?></a>&nbsp;
<?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && (!$_G['setting']['forumseparator'] || !$separatepos) && !$_GET['filter']) { ?>
<a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">查看更新</a>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="xi2<?php if($_GET['filter'] == 'digest') { ?> xw1<?php } ?>">精华</a><span class="pipe">|</span>
...
<tbody id="separatorline" class="emptb"><tr><?php if(!$_GET['archiveid'] && $_G['forum']['ismoderator']) { ?><td class="o"></td><?php } ?><td></td><td></td></tr></tbody>
<?php } ?>
...
<td>&nbsp;</td>
<td><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></td>
</tr>
</tbody>
...
<?php } elseif($thread['folder'] != 'common') { ?>
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/image.png" alt="attach_img" title="图片附件" align="absmiddle" />
...
<a href="forum.php?mod=redirect&amp;tid=<?php echo $thread['tid'];?>&amp;goto=lastpost#lastpost" class="xi1">
<img src="<?php echo $_G['style']['styleimgdir'];?>/new.png" alt="New" title="图片附件" align="absmiddle" />
</a>
...
<?php if($thread['typehtml'] || $thread['sorthtml']) { ?>
<div class="by forum">
...
<em><span<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo dgmdate($thread['dbdateline'],'Y-m-d'); ?></span></em>
</div>
<div class="by poster">
...
<div class="num"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></a><em><?php echo $thread['allreplies'];?></em></div>
</div>
</td>
</tr>
</tbody>
...
<ul>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if(!$_GET['orderby']) { ?>class="xw1"<?php } ?>>默认排序</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=author&amp;orderby=dateline<?php echo $forumdisplayadd['author'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['orderby'] == 'dateline') { ?>class="xw1"<?php } ?>>发帖时间</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=reply&amp;orderby=replies<?php echo $forumdisplayadd['reply'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['orderby'] == 'replies') { ?>class="xw1"<?php } ?>>回复</a></li>
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=reply&amp;orderby=views<?php echo $forumdisplayadd['view'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['orderby'] == 'views') { ?>class="xw1"<?php } ?>>查看</a></li>
</ul>
</div>
...
<span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'12'})"<?php } ?> class="pgb y"><a href="forum.php">返&nbsp;回</a></span>
...
<?php } } ?>
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameXtkUez" class="frame move-span cl frame-1"><div id="frameXtkUez_left" class="column frame-1-c"><div id="frameXtkUez_left_temp" class="move-span temp"></div><?php block_display('30');?><?php block_display('31');?><?php block_display('32');?></div></div></div><!--[/diy]-->
</div>
