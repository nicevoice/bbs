...
<img src="<?php echo IMGDIR;?>/thread_prize_s.png" class="vm" alt="回帖奖励" />
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_title_row'])) echo $_G['setting']['pluginhooks']['viewthread_title_row'];?><?php $postcount = 0;?><?php if($postlist[$_G['forum_firstpid']]) { $firstpost = $post = $postlist[$_G['forum_firstpid']];?><div id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<table id="pid<?php echo $post['pid'];?>" class="plhin first" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
<tr>
...
<div id="fj" class="y">
<label class="z" style="display:none;">电梯直达</label>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>">[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]</a><span class="pipe">|</span>
<?php } else { ?>
[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]<span class="pipe">|</span>
<?php } } $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><!--
<?php if($_self ) { ?>
...
<?php } } ?>
<a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xw1"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a><?php echo $authorverifys;?>
-->
...
&nbsp;<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo dgmdate($post['dbdateline'],'Y-m-d'); ?></em>
...
<?php } } } ?>
<span class="xi1 views"><?php echo $_G['forum_thread']['views'];?></span> <span class="xi1 replies"><?php echo $_G['forum_thread']['allreplies'];?></span>
<?php if($post['first']) { ?>
...
<dd style="margin:0">
<h3 class="psth xs1"><span class="icon_ring vm"></span>评分								<a href="javascript:;" onclick="toggleRatelogCollapse('ratelog_<?php echo $post['pid'];?>', this);" class="y xi2 op"><?php if(!empty($_G['cookie']['ratecollapse'])) { ?>展开<?php } else { ?>收起<?php } ?></a></h3>
</dd>
...
<table class="ratl">
<tr>
<th class="xw1" width="160"><a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分"> 参与人数 <span class="xi1"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></span></a></th><?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { if($score > 0) { ?>
<th class="xw1" width="120"><?php echo $_G['setting']['extcredits'][$id]['title'];?> <i><span class="xi1">+<?php echo $score;?></span></i></th>
<?php } else { ?>
<th class="xw1" width="120"><?php echo $_G['setting']['extcredits'][$id]['title'];?> <i><span class="xi1"><?php echo $score;?></span></i></th>
<?php } } ?>
<th>
...
<a class="rate" href="javascript:;" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;">评分</a>
...
<a class="report" href="javascript:;" onclick="showWindow('miscreport<?php echo $post['pid'];?>', 'misc.php?mod=report&rtype=post&rid=<?php echo $post['pid'];?>&tid=<?php echo $_G['tid'];?>&fid=<?php echo $_G['fid'];?>', 'get', -1);return false;">举报</a>
<?php } ?>
</em>
...
<?php } if($_G['group']['raterange'] && $post['authorid']) { $ratenumber = count($postlist[$post[pid]][totalrate]);?><a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场"><i><img src="<?php echo IMGDIR;?>/agree.gif" alt="评分" />评分</i><span id="ratenumber"<?php if(!$ratenumber) { ?> style="display:none"<?php } ?>><?php echo $ratenumber;?></span></a>
<?php } if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { ?>
<a id="k_fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)"><i><img src="<?php echo IMGDIR;?>/tree_root.gif" alt="收藏" />回复</i><span id="replynumber"<?php if(!$_G['forum_thread']['allreplies']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['allreplies'];?></span></a>
<?php } ?>
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><i><img src="<?php echo IMGDIR;?>/fav.gif" alt="收藏" />收藏</i><span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></a>
<?php if(!$post['anonymous'] && $post['first'] && helper_access::check_module('follow')) { ?>
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><i><img src="<?php echo IMGDIR;?>/rt.png" alt="转播" />转播</i><?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<!--a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><i><img src="<?php echo IMGDIR;?>/oshr.png" alt="分享" />分享</i><?php if($_G['forum_thread']['sharetimes']) { ?><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></a-->
<?php } ?>
<a href="javascript:void(0)" class="sharep bdsharebuttonbox" data-cmd="more" title="分享推精华">分享</a>

<?php if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="forum.php?mod=collection&amp;action=edit&amp;op=addthread&amp;tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><i><img src="<?php echo IMGDIR;?>/collection.png" alt="分享" />淘帖</i><span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> style="display:none"<?php } ?>><?php echo $post['releatcollectionnum'];?></span></a>
<?php } ?>
...
<?php } if($_G['forum_thread']['replies']) { ?>
<div class="post_comment_top">
<a id="comment_top" name="comment_top"></a>
<h2>共 <?php echo $_G['forum_thread']['replies'];?> 个关于<?php echo $_G['forum_thread']['subject'];?>的回复 最后回复于 <?php echo dgmdate($_G['forum_thread']['lastpost'], 'u');?></h2>
<?php if($_GET['page'] > 1 || $_GET['authorid']) { ?>
...
<div class="bm_h">
<h1<?php if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?> class="a"<?php } ?>>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>" rel="nofollow">查看全部</a>
</h1>
<h1 style="margin-left:10px;"<?php if(!IS_ROBOT && $_GET['authorid'] == $_G['forum_thread']['authorid'] && !$_G['forum_thread']['archiveid']) { ?> class="a"<?php } ?>>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $post['tid'];?>&amp;page=<?php echo $page;?>&amp;authorid=<?php echo $_G['forum_thread']['authorid'];?>" rel="nofollow">只看楼主</a>
</h1>
</div>
<?php } ?>
...
</div><?php unset($postlist[$_G['forum_firstpid']]);?><?php $postcount++;?><?php } if(is_array($postlist)) foreach($postlist as $post) { if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { continue;?><?php } ?>
<div id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>><?php if($post['first'] && $_GET['viewpid'] == $post['pid']) { $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
$postshowavatars = !($_G['setting']['bannedmessages'] & 2 && ($post['memberstatus'] == '-1' || ($post['authorid'] && !$post['username']) || ($post['groupid'] == 4 || $post['groupid'] == 5) || ($post['status'] & 1)));?><?php
$authorverifys = <<<EOF
...
<?php } else { $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
$postshowavatars = !($_G['setting']['bannedmessages'] & 2 && ($post['memberstatus'] == '-1' || ($post['authorid'] && !$post['username']) || ($post['groupid'] == 4 || $post['groupid'] == 5) || ($post['status'] & 1)));?><?php
$authorverifys = <<<EOF
...
<div id="threadstamp"><img src="<?php echo STATICURL;?>image/stamp/<?php echo $_G['forum_threadstamp']['url'];?>" title="<?php echo $_G['forum_threadstamp']['text'];?>" /></div>
<?php } if(empty($post['deleted'])) { ?>
<table id="pid<?php echo $post['pid'];?>" class="plhin plcom" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
<tr>
<?php if(!$close_leftinfo) { ?>
...
<?php } ?>
<td class="plc plcon"<?php if($close_leftinfo) { ?> style="width:100%"<?php } ?>>
<div class="pi"<?php if($close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars) { ?> style="height:48px"<?php } ?>>
<?php if(!IS_ROBOT) { if(!$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { ?>
<div id="fj" class="y">
...
<?php } if($post['first'] == 99 && $post['signature'] && ($_G['setting']['bannedmessages'] & 4 && ($post['memberstatus'] == '-1' || ($post['authorid'] && !$post['username']) || ($post['groupid'] == 4 || $post['groupid'] == 5) || ($post['status'] & 1)))) { ?>
<div class="sign">签名被屏蔽</div>
<?php } elseif($post['first'] == 99 && $post['signature'] && !$post['anonymous'] && $showsignatures) { ?>
<div class="sign" style="max-height:<?php echo $_G['setting']['maxsigrows'];?>px;maxHeightIE:<?php echo $_G['setting']['maxsigrows'];?>px;"><?php echo $post['signature'];?></div>
<?php } elseif($post['first'] == 99 && !$post['anonymous'] && $showsignatures && $_G['setting']['globalsightml']) { ?>
<div class="sign"><?php echo $_G['setting']['globalsightml'];?></div>
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_postsightmlafter'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_postsightmlafter'][$postcount];?><?php echo adshow("thread/a_pb/1/$postcount");?></td>
</tr>
...
<div class="pob cl">
<em>
<?php if($post['first'] == 99 && $_G['group']['raterange'] && $post['authorid']) { ?>
<a class="rate" href="javascript:;" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;">评分</a>
<?php } if($post['invisible'] == 0) { if($post['first'] == 99 && $allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?><a class="cmmnt" href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>" onclick="showWindow('comment', this.href, 'get', 0)">点评</a><?php } if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { if($post['first']) { ?>
<a class="fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复</a>
<?php } else { ?>
<a class="fastre" href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复</a>
<?php } } } if((($_G['forum']['ismoderator'] && $_G['group']['alloweditpost'] && (!in_array($post['adminid'], array(1, 2, 3)) || $_G['adminid'] <= $post['adminid'])) || ($_G['forum']['alloweditpost'] && $_G['uid'] && ($post['authorid'] == $_G['uid'] && $_G['forum_thread']['closed'] == 0) && !(!$alloweditpost_status && $edittimelimit && TIMESTAMP - $post['dbdateline'] > $edittimelimit)))) { ?>
...
<label for="fastpostrefresh" class="y"><input id="fastpostrefresh" type="checkbox" class="pc" />回帖后跳转到最后一页</label>
...
<?php echo $multipage;?>
<span class="pgb y"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforumstmp" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'12'})"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span>
</div>
...
<a id="newpost" class="z" href="javascript:;" <?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><span>发表</span></a>
<div id="signin" class="y">
<?php if(!empty($_G['setting']['pluginhooks']['global_sign_show'])) echo $_G['setting']['pluginhooks']['global_sign_show'];?>
</div>
</div>
<?php if($postlist[$_G['forum_firstpid']]['relateitem']) { ?>
<div class="bm">
<div class="bm_h"><h2>相关帖子</h2></div>
<div class="bm_c">
<ul class="cl"><?php if(is_array($postlist[$_G['forum_firstpid']]['relateitem'])) foreach($postlist[$_G['forum_firstpid']]['relateitem'] as $var) { ?><li>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $var['tid'];?>" title="<?php echo $var['subject'];?>" target="_blank"><?php echo $var['subject'];?></a>
<em><?php echo dgmdate($var['dateline'],'Y-m-d'); ?></em><a class="author" href="home.php?mod=space&amp;uid=<?php echo $var['authorid'];?>" target="_blank"><?php echo $var['author'];?></a>
</li>
<?php } ?>
</ul>
</div>
...
<?php } ?>
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameKPnOnz" class="frame move-span cl frame-1"><div id="frameKPnOnz_left" class="column frame-1-c"><div id="frameKPnOnz_left_temp" class="move-span temp"></div><?php block_display('33');?><?php block_display('34');?></div></div></div><!--[/diy]-->
</div>
</div>
<?php } ?>
</div>
