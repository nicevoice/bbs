...
0
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1437287765, '5', './data/template/6_5_portal_portalcp_block.tpl.php', './template/yunshan_vivo', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1437287765, '5', './data/template/6_5_portal_portalcp_block.tpl.php', './template/yunshan_vivo', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_setting.htm', 1437287765, '5', './data/template/6_5_portal_portalcp_block.tpl.php', './template/yunshan_vivo', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_block_thumbsetting.htm', 1437287765, '5', './data/template/6_5_portal_portalcp_block.tpl.php', './template/yunshan_vivo', 'portal/portalcp_block')
|| checktplrefresh('./template/default/portal/portalcp_block.htm', './template/default/portal/portalcp_nav.htm', 1437287765, '5', './data/template/6_5_portal_portalcp_block.tpl.php', './template/yunshan_vivo', 'portal/portalcp_block')
