...
0
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/default/common/header_common.htm', 1437287754, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/yunshan_vivo', 'common/header_forum_post')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_qmenu.htm', 1437287754, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/yunshan_vivo', 'common/header_forum_post')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/pubsearchform.htm', 1437287754, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/yunshan_vivo', 'common/header_forum_post')
|| checktplrefresh('./template/yunshan_vivo/common/header.htm', './template/yunshan_vivo/common/header_userstatus.htm', 1437287754, '5', './data/template/6_5_common_header_forum_post.tpl.php', './template/yunshan_vivo', 'common/header_forum_post')
;?>
