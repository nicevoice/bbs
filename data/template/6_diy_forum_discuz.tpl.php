...
<div class="wp cl">
<div class="chart">
<p class="chart_today"><i></i>今日: <em><?php echo $todayposts;?></em></p>
<p class="chart_yesterday"><i></i>昨日: <em><?php echo $postdata['0'];?></em></p><p class="chart_posts"><i></i>帖子: <em><?php echo $posts;?></em></p>
<p class="chart_members"><i></i>会员: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em></p>
<?php if($_G['cache']['userstats']['newsetuser']) { ?>
<p class="chart_new"><i></i>欢迎新会员: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em></p>
<?php } ?>
</div>
<!--div class="y">
...
<div id="signin_box" class="y">
<a id="newpost" class="z" href="forum.php?mod=misc&amp;action=nav&amp;special=0&amp;" id="fjump" onclick="showWindow('nav', this.href);return false;"><span>发表</span></a>
...
<div class="fl_icn_g"<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="width: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } if($forum['icon']) { ?> data-fid="<?php echo $forum['fid'];?>"<?php } ?>>
<?php if($forum['icon']) { ?>
<?php echo $forum['icon'];?>
<?php } else { ?>
...
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameEA6M8z" class="frame move-span cl frame-1"><div id="frameEA6M8z_left" class="column frame-1-c"><div id="frameEA6M8z_left_temp" class="move-span temp"></div><?php block_display('15');?><?php block_display('16');?><?php block_display('17');?></div></div></div><!--[/diy]-->
</div>
